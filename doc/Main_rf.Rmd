...
This section explores training a predictive model with Random Forest. I will tune the model with different hyperparameters and handling the imbalanced data.
...
run.rose <- FALSE # regenerate balanced data with ROSE method
